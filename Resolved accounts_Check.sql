...
/* Require payment_date and check_no when Accounts_payable is resolved. When condition is met, automatically update used supplier credit in both Supplier table and Purchasing_Order table */
...
/* Require payment_date and check_no when Accounts_receivable is resolved. When condition is met, automatically update used customer credit in both Customer table and Orders table */
